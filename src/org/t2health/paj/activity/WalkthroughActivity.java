...
//			wvDescription.setVisibility(View.VISIBLE);
	...
	public String GetStepZero()
	{
		...
		output += "<P>The first step is to deselect all the individuals from your contact list that you don’t think you’d want to ever do an activity with.";
	...
	public String GetStepOne()
	{
		...
		output += "<P>Now you need to deselect all activities you would not like to try. Don’t worry, if you decide you want to change any of these settings in the future, you can go back to the Settings tab and change this.";
