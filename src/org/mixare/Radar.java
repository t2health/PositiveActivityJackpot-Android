...
public class Radar {
	...
	private static final int RADAR_COLOR = Color.argb(100, 144, 144, 184);
	...
	public void draw(Canvas canvas) {
		...
		//TODO: steveo - move and resize the radar
		RADIUS = (canvas.getHeight() / 2) - 40;
		PAD_X = ((canvas.getWidth() / 2 ) - RADIUS);
